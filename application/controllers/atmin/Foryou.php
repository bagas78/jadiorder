...
class Foryou extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('atmin/admin/head',["menu"=>37]);
		$this->load->view('atmin/foryou/index');
	...
	public function data(){
		...
		if(isset($_GET["load"])){
			$res = $this->load->view("atmin/foryou/data","",true);
