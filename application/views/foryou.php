	...
	<section class="p-t-30 p-b-65">
		<div class="container">
			<div class="p-b-50 hidesmall">
				<button class="btn btn-outline-secondary bg-white pencarian-btn m-r-4 m-r-0-sm" disabled><i class="fas fa-bolt text-warning"></i> &nbsp;Produk Foryou</button>
			</div>
			<div class="section-title p-b-20 showsmall">
				<div class="row">
					<div class="col-8">
                        <button class="btn btn-outline-secondary bg-white pencarian-btn m-r-4 m-r-0-sm" disabled><i class="fas fa-bolt text-warning"></i> &nbsp;FOR YOU</button>
                    </div>
