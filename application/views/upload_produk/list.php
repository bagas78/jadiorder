<?php
			...
			foreach($db->result() as $r){
				...
				$button = "
					...
					<a href='".site_url('upload_produk/add/?copy='.$r->id)."' title='copy' class='btn btn-success btn-sm m-b-4'><i class='fas fa-copy'></i> Duplicate</a>
					<a href='".site_url('upload_produk/add/'.$r->id)."' title='edit' class='btn btn-primary btn-sm m-b-4'><i class='fas fa-pencil-alt'></i> Edit</a>
