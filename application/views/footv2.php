					...
					<div class="row">
						<?php
							...
							foreach($datab as $key=>$val){
								echo "<div class='col-4 m-b-12'><img src='".base_url('assets/images/payment/'.$val)."' class='w-full'></div>";
							}
						?>
					</div>
				</div>
					...
					<?php
						...
						for($i=0; $i<count($kurir); $i++){
							...
							if(file_exists(FCPATH."assets/images/kurir/".$kur.".png")){
								echo '<img style="width:28%;margin:2%;" src="'.base_url("assets/images/kurir/".$kur.".png").'" />';
							}
						}
					?>
				</div>
