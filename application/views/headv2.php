			...
			<div class="container">
				<div class="col-md-3">
					<a class="navbar-brand" href="<?=site_url()?>">
						<img src="<?= base_url('assets/images/'.$set->logo) ?>" height="40" />
					</a>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-3">
					<a class="top-link p-r-10" href="<?=site_url('home/keranjang')?>">
						<i class="fas fa-shopping-basket text-primary fs-28"></i> <b class="badge badge-danger p-lr-8 jmlkeranjang"><?=$keranjang?></b>
					</a>
				...
				<div class="collapse navbar-collapse" id="navbarToggler">
					...
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
						...
						<?php }else{ ?>
							...
							<li class="nav-item">
								<a class="nav-link" href="javascript:void(0)" onclick="signoutNow()"><i class="fas fa-power-off text-danger"></i> Logout</a>
							</li>
						<?php } ?>
					</ul>
				</div>
