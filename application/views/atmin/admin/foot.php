...
<script type="text/javascript">
	...
	function playNotif(){
		$.post("<?=site_url("atmin/api/cekupdatenotif")?>",{[$("#names").val()]:$("#tokens").val()},function(e){
			var data = eval("("+e+")");
			//updateToken(data.token);
	...
	function logout(){
		swal.fire({
			...
			if(vals.value == true){
				window.location.href = "<?=site_url("atmin/manage/logout")?>";
			}
		});
	}
	...
	function resetToken(){
		$("#tokentempo").load("<?=site_url("atmin/api/resetoken")?>",function(){
