            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>Judul</label>
                        <input type="text" name="caption" class="form-control col-md-10" value="<?php echo (isset($r->caption)) ? $this->func->cleanURL($r->caption) : ""; ?>" />
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control col-md-6" name="jenis" required >
							...
							<option value="4"<?php echo (isset($r->jenis) AND $r->jenis == 4) ? " selected" : ""; ?>>POPUP BANNER</option>
						</select>
                    </div>
                    <div class="form-group">
                        <label>Link Promo</label>
                        <input type="text" name="link" class="form-control" value="<?php echo (isset($r->link)) ? $this->func->cleanURL($r->link) : ""; ?>" />
                    </div>
