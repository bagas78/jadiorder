			...
			<div class="scrollbar-inner sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item <?php echo (isset($menu) AND $menu == 30) ? "active" : "" ?>">
						<a href="<?=site_url("atmin/ppob/pesanan")?>">
