...
<script type="text/javascript">
	...
	function loadUser(level){
		$.post("<?=site_url("atmin/api/getusrid")?>?level="+level,{[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval("("+msg+")");
	...
	function loadRiwayat(){
		...
		$.post("<?=site_url("atmin/manage/laporanuser?load=hal")?>",{"usrid":$("#usrid").val(),"tglmulai":$("#tglmulai").val(),"tglselesai":$("#tglselesai").val(),[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval("("+msg+")");
			updateToken(data.token);
