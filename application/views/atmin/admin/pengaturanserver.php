        ...
        <?php
			if($this->func->demo() == true){
				...
				echo '
					...
					$.post("'.site_url('atmin/api/savesetting').'",{"api_wasap":val,[$("#names").val()]:$("#tokens").val()},function(ev){
						var data = eval("("+ev+")");
        ...
        <?php
			if($this->func->demo() == true){
				...
				echo '
					...
					$.post("'.site_url('atmin/api/savesetting').'",{"login_otp":val,[$("#names").val()]:$("#tokens").val()},function(ev){
						var data = eval("("+ev+")");
						updateToken(data.token);
						if(val == 1){
