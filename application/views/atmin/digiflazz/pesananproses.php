<div class="table-responsive">
	<table class="table table-condensed table-hover">
		...
		<?php
			...
			$where = "status = 1 AND (invoice LIKE '%$cari%' OR bayar LIKE '%$cari%' OR usrid IN(".$in.") OR idproduk IN(".$int."))"; 
			$this->db->select("id");
			$this->db->where($where);
		...
		?>
			<tr>
				<td><b>#<?=$r->invoice?></b><br/><i class="fas fa-cclock text-warning"></i> &nbsp;<?=$this->admfunc->ubahTgl("d/m/Y H:i",$r->tgl);?></td>
